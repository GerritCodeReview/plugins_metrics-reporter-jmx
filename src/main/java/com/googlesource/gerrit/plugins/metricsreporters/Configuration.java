...
public class Configuration {
  private static final Logger log = LoggerFactory.getLogger(GerritJmxReporter.class);
  ...
  public Configuration(@PluginName String pluginName, SitePaths site) {
    ...
    try {
      config.load();
      excludes =
          new HashSet<>(Arrays.asList(config.getStringList(METRICS_SECTION, null, EXCLUDE_KEY)));
    } catch (IOException e) {
